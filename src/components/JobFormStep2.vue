<template>
  <form class="mt-6">
    <div class="lg:flex lg:items-start lg:gap-x-28">
      <div class="mt-6 mb-4 lg:basis-64">
    ...
    <div class="lg:flex lg:items-start lg:gap-x-28">
      ...
      <TextEditor v-model="responsibilites" />
    </div>
    <hr class="my-6" />
    <div class="lg:flex lg:items-start lg:gap-x-28">
      <div class="mt-6 mb-4 lg:basis-64">
    ...
    <div class="lg:flex lg:items-start lg:gap-x-28">
      ...
      <TextEditor v-model="nicetohaves" />
    </div>
    <hr class="mt-6" />

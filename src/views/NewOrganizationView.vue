  ...
  <div>
    <div class="rounded bg-soft p-8 md:w-96 min-w-full">
      ...
      <FormKit type="form" id="saveOrganization" @submit="saveOrganization" form-class="space-y-8" :actions=false :incomplete-message=false novalidate>
        ...
        <div class="">
          <div class="flex">
            <button type="submit" class="mr-3 inline-flex justify-center rounded-md border border-transparent bg-blue-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">Create organization</button>
